...
class dns{
    ...
    String subdns (String s)
    {
        ...
        System.out.print("Now in Server: \t");
        int dotloc = s.indexOf(".");
        StringBuilder sb1 = new StringBuilder(s.substring(0,dotloc));
        sb1.reverse();
        System.out.println(sb1.toString());

        dotloc++;
        s = s.substring(dotloc);
        return subdns(s);
    ...
    String subdns2 (String s)
    {
        ...
        System.out.print("Back to Server: ");
        int dotloc = s.indexOf(".");
        System.out.println(s.substring(0,dotloc));
        dotloc++;
        s = s.substring(dotloc);
        return subdns2(s);
    ...
    public static void main(String[] args)
    {
        ...
        for (int i = arrOfStr.length-2; i >= 0; i--)
            {
                System.out.print("Client's name resolver --> Name Server node :\t");
        ...
        sb.reverse();
        System.out.println(d.subdns(sb.toString()));
        System.out.println();

        int dotloc = ad.indexOf(".");
        dotloc++;
